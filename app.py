...
def desc_calc():
    ...
    bashCommand = "java -Xms2G -Xmx2G -Djava.awt.headless=true -jar ./PaDEL-Descriptor/PaDEL-Descriptor.jar " \
                  "-removesalt -standardizenitro -fingerprints -descriptortypes " \
...
**Credits**
- App built in `Python` + `Streamlit` by [Janmejay Vyas](https://github.com/Janmejay-Vyas)
- Descriptor calculated using [PaDEL-Descriptor](http://www.yapcwsoft.com/dd/padeldescriptor/) [[Read the Paper]](https://doi.org/10.1002/jcc.21707).
---
""")

# Sidebar
with st.sidebar.header('1. Upload your smiles data in .txt format'):
